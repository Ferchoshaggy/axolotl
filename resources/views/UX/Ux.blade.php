...
<style type="text/css">
  ...
  .boton_morado:hover{
    ...
    @section('content')
        ...
        <div class="card">
            <div class="card-body">
                        ...
                        <tbody>
                            @forelse($uxs as $ux)
                                @if (Auth::user()->id_proyecto_select == $ux->id_proyecto)
                                    <tr class="marca">
                                        <td style="text-align: center;">{{ $ux->clave }}</td>
                                        ...
                                        <td style="text-align: center;"><button class="btn"
                                                ...
                                                data-target="#modal-delete-{{ $ux->id }}">ELIMINAR
                                            </button></td>
                                        @if ($ux->archivo == null)
                                            <td style="text-align: center;"><a href="{{ $ux->link }}" target="_blank"
                                                    class="btn"
                                                    style="background: rgb(226, 94, 134); color:white;">Ver</a></td>
                                        @else
                                            <td style="text-align: center;"><a href="{{ route('descargar_ux', $ux->uuid) }}"
                                                    class="btn"
                                    ...
                                    <!-- modal eliminar -->
                                    <div class="modal fade" id="modal-delete-{{ $ux->id }}" tabindex="-1"
                                            ...
                                            <form action="{{ route('eliminar_ux', $ux->id) }}" method="POST">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Deseas Eliminar el UX <br> <label
                                                            style="color: red">{{ $ux->nombre }}</label>
                                                    </div>
                ...
                <div style="display:flex; justify-content:flex-end; margin:2% 0 0 85%;">
                    ...
                    <button class="form-control btn btn-primary" data-toggle="modal" data-target="#ModalUX"
        ...
        <!-- Modal Nuevo UX -->
        <div class="modal fade bd-example-modal-lg" id="ModalUX" tabindex="-1" role="dialog"
