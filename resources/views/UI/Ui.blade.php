...
@section('content_header')
    ...
    @section('content')
        ...
        <div class="card">
            <div class="card-body">
                                ...
                                @if (Auth::user()->id_proyecto_select == $ui->id_proyecto)
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><button class="btn"
                                                ...
                                                data-target="#modal-delete-{{ $ui->id }}">ELIMINAR
                                            </button></td>
                                            @if ($ui->archivo == null)
                                            <td style="text-align: center;"><a href="{{ $ui->link }}" target="_blank"
                                                    class="btn"
                                                    style="background: rgb(226, 94, 134); color:white;">Ver</a></td>
                                        @else
                                            <td style="text-align: center;"><a href="{{ route('descargar_ui', $ui->uuid) }}"
                                                    class="btn"
                                    ...
                                    <!-- modal eliminar -->
                                    <div class="modal fade" id="modal-delete-{{ $ui->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <form action="{{ route('eliminar_ui', $ui->id) }}" method="POST">
                                                @method('DELETE')
                                                @csrf
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Eliminar UI</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        Deseas Eliminar el UI <br> <label
                                                            style="color: red">{{ $ui->nombre }}</label>
                                                    </div>
                ...
                <div style="display:flex; justify-content:flex-end; margin:2% 0 0 85%;">
                    ...
                    <button class="form-control btn btn-primary" data-toggle="modal" data-target="#ModalUI"
        ...
        <!-- Modal Nuevo UI-->
        <div class="modal fade bd-example-modal-lg" id="ModalUI" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{ route('guardar_ui') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <label>
                                        <div class="form-check form-check-inline">
                                            <input id="my-input" class="form-check-input" type="radio"
                                                name="documento" value="archivo" onchange="radioSelec(this.value);">
                                            <label for="my-input" class="form-check-label">Archivo</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input id="my-input" class="form-check-input" type="radio"
                                                name="documento" value="link" onchange="radioSelec(this.value);">
